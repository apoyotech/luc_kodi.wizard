...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red]luc_kodi.wizard[/COLOR]'
...
ICONYOUTUBE = 'http://'#os.path.join(ART, 'youtube.png')
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = '[B][COLOR black]Thank you for choosing OpenWizard.[/COLOR][/B][B][COLOR snow]\n\nContact us on Github at http://www.github.com/drinfernoo/plugin.program.openwizard/[/COLOR][/B]'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red]luc_kodi.wizard[/COLOR]'
